...
const decrypt$2 = (enc2, cek, ciphertext, iv, tag2, aad) => {
  let key;
...
async function decryptKeyManagement(alg2, key, encryptedKey, joseHeader, options) {
  ...
  key = await normalize.normalizePrivateKey?.(key, alg2) || key;
  switch (alg2) {
    case "dir": {
...
async function flattenedDecrypt(jwe, key, options) {
  ...
  const plaintext = await decrypt$2(enc2, cek, ciphertext, iv, tag2, additionalData);
...
async function encryptKeyManagement(alg2, enc2, key, providedCek, providedParameters = {}) {
  ...
  key = await normalize.normalizePublicKey?.(key, alg2) || key;
  switch (alg2) {
    case "dir": {
      cek = key;
      break;
...
class FlattenedEncrypt {
  ...
  async encrypt(key, options) {
    ...
    const { ciphertext, tag: tag2, iv } = await encrypt(enc2, this._plaintext, cek, this._iv, additionalData);
    const jwe = {
...
function parseActionAndProviderId(pathname, base2) {
  ...
  const actionAndProviderId = a2.at(-1);
...
l$1 = { __e: function(n2, l2, u2, i2) {
  for (var t, o2, r2; l2 = l2.__; ) if ((t = l2.__c) && !t.__) try {
    if ((o2 = t.constructor) && null != o2.getDerivedStateFromError && (t.setState(o2.getDerivedStateFromError(n2)), r2 = t.__d), null != t.componentDidCatch && (t.componentDidCatch(n2, i2 || {}), r2 = t.__d), r2) return t.__E = t;
  } catch (l3) {
    n2 = l3;
  }
  throw n2;
...
function y(r2, a2, c2, u2, d2, m2) {
  if (null == r2 || "boolean" == typeof r2) return "";
  if ("object" != typeof r2) return l(r2);
  var b2 = c2.pretty, x2 = b2 && "string" == typeof b2 ? b2 : "	";
  if (Array.isArray(r2)) {
    for (var k2 = "", S2 = 0; S2 < r2.length; S2++) b2 && S2 > 0 && (k2 += "\n"), k2 += y(r2[S2], a2, c2, u2, d2, m2);
    return k2;
  }
  ...
  if ("function" == typeof C2) {
    if (j2 = true, !c2.shallow || !u2 && false !== c2.renderRootComponent) {
      ...
      } else for (var T = h(C2, a2), E = 0; H.__d && E++ < 25; ) H.__d = false, M && M(r2), F = C2.call(r2.__c, O2, T);
    ...
    C2 = (w2 = C2).displayName || w2 !== Function && w2.name || function(e) {
      ...
      if (!t) {
        for (var r3 = -1, n2 = g.length; n2--; ) if (g[n2] === e) {
          r3 = n2;
          break;
        }
      ...
      if ("children" !== I) {
        if (!o$1.test(I) && (c2 && c2.allAttributes || "key" !== I && "ref" !== I && "__self" !== I && "__source" !== I)) {
          if ("defaultValue" === I) I = "value";
            ...
            I = "class";
          } else d2 && i.test(I) && (I = I.toLowerCase().replace(/^xlink:?/, "xlink:"));
          if ("htmlFor" === I) {
            if (O2.for) continue;
            I = "for";
          }
  ...
  if (N += ">", o$1.test(C2)) throw new Error(C2 + " is not a valid HTML tag name in " + N);
  ...
  else if (c2 && c2.xml) return N.substring(0, N.length - 1) + " />";
...
function j(r2, i2, a2, s2) {
  if (null == r2 || true === r2 || false === r2 || "" === r2) return "";
  if ("object" != typeof r2) return l(r2);
  if (C(r2)) {
    for (var f2 = "", c2 = 0; c2 < r2.length; c2++) f2 += j(r2[c2], i2, a2, s2);
    return f2;
  }
  l$1.__b && l$1.__b(r2);
  var u2 = r2.type, p2 = r2.props;
  if ("function" == typeof u2) {
    if (u2 === p$1) return j(r2.props.children, i2, a2, s2);
    var _2;
    _2 = u2.prototype && "function" == typeof u2.prototype.render ? function(e, r3) {
      ...
      e.__c = o2;
      for (var a3 = l$1.__r, l2 = 0; o2.__d && l2++ < 25; ) o2.__d = false, a3 && a3(e), n2 = e.type.call(o2, e.props, i3);
      return n2;
    }(r2, i2);
    var d2 = r2.__c;
  ...
  var y2, m2, b2 = "<";
  if (b2 += u2, p2) for (var x2 in y2 = p2.children, p2) {
    var k2 = p2[x2];
    if (!("key" === x2 || "ref" === x2 || "__self" === x2 || "__source" === x2 || "children" === x2 || "className" === x2 && "class" in p2 || "htmlFor" === x2 && "for" in p2 || o$1.test(x2))) {
      if (k2 = w(x2 = S(x2, a2), k2), "dangerouslySetInnerHTML" === x2) m2 = k2 && k2.__html;
      else if ("textarea" === u2 && "value" === x2) y2 = k2;
  ...
  var A = b2;
  if (b2 += ">", o$1.test(u2)) throw new Error(u2 + " is not a valid HTML tag name in " + b2);
  var F = "", H = false;
  if (m2) F += m2, H = true;
  else if ("string" == typeof y2) F += l(y2), H = true;
  else if (C(y2)) for (var M = 0; M < y2.length; M++) {
    var L = y2[M];
    if (null != L && false !== L) {
  ...
  if (l$1.diffed && l$1.diffed(r2), H) b2 += F;
  else if (n.test(u2)) return A + " />";
  return b2 + "</" + u2 + ">";
}
k.shallowRender = b;
var _ = 0;
function o(o2, e, n2, t, f2) {
  var l2, s2, u2 = {};
  for (s2 in e) "ref" == s2 ? l2 = e[s2] : u2[s2] = e[s2];
  ...
  if ("function" == typeof o2 && (l2 = o2.defaultProps)) for (s2 in l2) void 0 === u2[s2] && (u2[s2] = l2[s2]);
...
async function processUserInfoResponse(as, client, expectedSubject, response) {
  ...
  if (getContentType(response) === "application/jwt") {
    assertReadableResponse(response);
    const { claims } = await validateJwt(await response.text(), checkSigningAlgorithm.bind(void 0, client.userinfo_signed_response_alg, as.userinfo_signing_alg_values_supported), noSignatureCheck, getClockSkew(client), getClockTolerance(client)).then(validateOptionalAudience.bind(void 0, client.client_id)).then(validateOptionalIssuer.bind(void 0, as.issuer));
    json = claims;
  } else {
    if (client.userinfo_signed_response_alg) {
